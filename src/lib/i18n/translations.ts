...
const T = {
  ...
  "judge.syncing": { cs: "Synchronizuji...", en: "Syncing..." },
  "judge.sync_rejected": { cs: "Kolo bylo uzavřeno dříve, než se vaše body stihly odeslat. Kontaktujte vedoucího soutěže.", en: "The round was closed before your marks could be synced. Contact the competition chair." },
  "judge.offline_cached_data": { cs: "Zobrazuji data uložená před {minutes} min — aktualizuje se po obnovení spojení", en: "Showing data cached {minutes} min ago — will refresh when back online" },
  "judge.offline_cached_stale": { cs: "Data jsou stará — ověřte, že bodujete správné kolo", en: "Cache may be stale — verify you are scoring the correct round" },
