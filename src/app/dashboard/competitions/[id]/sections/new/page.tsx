  ...
  const onSubmit = async (values: any) => {
    ...
    try {
      await createSection.mutateAsync({
        ...
        dances: [],
        ageCategory: (values.ageCategory || undefined) as AgeCategory | undefined,
        level: (values.level || undefined) as Level | undefined,
        danceStyle: (values.danceStyle || undefined) as DanceStyle | undefined,
